...
import (
	...
	restaurantv1beta1 "github.com/chanshik/pizza-apiserver/pkg/apis/restaurant/v1beta1"
	versioned "github.com/chanshik/pizza-apiserver/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/chanshik/pizza-apiserver/pkg/generated/informers/externalversions/internalinterfaces"
	v1beta1 "github.com/chanshik/pizza-apiserver/pkg/generated/listers/restaurant/v1beta1"
...
func (f *pizzaInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&restaurantv1beta1.Pizza{}, f.defaultInformer)
}

func (f *pizzaInformer) Lister() v1beta1.PizzaLister {
	return v1beta1.NewPizzaLister(f.Informer().GetIndexer())
}
