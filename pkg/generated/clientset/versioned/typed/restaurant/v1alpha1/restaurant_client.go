...
import (
	v1alpha1 "github.com/chanshik/pizza-apiserver/pkg/apis/restaurant/v1alpha1"
	"github.com/chanshik/pizza-apiserver/pkg/generated/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type RestaurantV1alpha1Interface interface {
	RESTClient() rest.Interface
	PizzasGetter
	ToppingsGetter
}

// RestaurantV1alpha1Client is used to interact with features provided by the restaurant.chanshik.dev group.
...
func NewForConfig(c *rest.Config) (*RestaurantV1alpha1Client, error) {
	...
	return &RestaurantV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new RestaurantV1alpha1Client for the given config and
...
func New(c rest.Interface) *RestaurantV1alpha1Client {
	return &RestaurantV1alpha1Client{c}
}
